...
void bx_instr_branch_taken(unsigned cpu, unsigned what, bx_address branch_eip, bx_address new_eip);
void bx_instr_branch_not_taken(unsigned cpu, unsigned what, bx_address branch_eip, bx_address new_eip);
...
/* branch resolution */
#define BX_INSTR_NEAR_BRANCH_TAKEN(cpu_id, what, branch_eip, new_eip) bx_instr_cnear_branch_taken(cpu_id, branch_eip, new_eip)
#define BX_INSTR_NEAR_BRANCH_NOT_TAKEN(cpu_id, what, branch_eip, new_eip) bx_instr_cnear_branch_not_taken(cpu_id, branch_eip, new_eip)
